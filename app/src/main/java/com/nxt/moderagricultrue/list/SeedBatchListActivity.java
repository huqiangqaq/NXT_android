...
//                et_05.setText(null);
            ...
            case R.id.confirm:
                ...
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_11,s),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_09,s));
                }
                String prs=et_02.getText().toString().trim();
                String ps="1&vccutsno="+prs;
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_11,ps),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_09,ps));
                }
                ...
                {
                    zDataTask.get(String.format(Constants.URL_11,buy),null,null,this);
    ...
    private void getData(){
        if (!ComUtils.isNetWorkConnected(this)) {
            ...
            zDataTask.get(String.format(Constants.URL_11,page),null,null,this);
        }
    }
