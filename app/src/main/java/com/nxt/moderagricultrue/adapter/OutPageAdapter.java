...
import com.nxt.moderagricultrue.list.Update_OutPageListActivity;
...
public class OutPageAdapter extends ZBaseAdapter<OutPage> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.ll_detail:
                mContext.startActivity(new Intent(mContext, OutPageDetailActivity.class).putExtra(Constants.VCRECNO,dataList.get(itemPosition)));
                break;
            case R.id.ll_update:
                mContext.startActivity(new Intent(mContext, Update_OutPageListActivity.class).putExtra(Constants.VCRECNO,dataList.get(itemPosition)));
                break;
            case R.id.ll_delete:
                AlertDialog dialog = new AlertDialog.Builder(mContext)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                OkHttpUtils.get().url(String.format(Constants.DEL_URL_02,dataList.get(itemPosition).getVcrecno()))
                                        .build()
