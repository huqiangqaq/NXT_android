...
public class UserDetailActivity extends BaseActivity {
    ...
    protected void initView() throws UnsupportedEncodingException {
        ...
        User vcrecno=(User) getIntent().getSerializableExtra(Constants.VCRECNO);
        if(vcrecno != null){
            tv_01.setText("姓名："+vcrecno.getName_());
            tv_01.setText("性别："+vcrecno.getSex_());
            tv_01.setText("出生日期："+vcrecno.getBirthday_());
            tv_01.setText("职称："+vcrecno.getFiled1_());
            tv_01.setText("专业："+vcrecno.getFiled2_());
            tv_01.setText("工种："+vcrecno.getFiled3_());
