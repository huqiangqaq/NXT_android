        ...
        new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Log.d("DEL",String.format(Constants.DEL_URL_05,dataList.get(itemPosition).getVcrecno()));
                        OkHttpUtils.get().url(String.format(Constants.DEL_URL_05,dataList.get(itemPosition).getVcrecno()))
                                .build()
