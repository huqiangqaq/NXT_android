...
//                        .getDisplayMetrics()));
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                zDataTask.get(String.format(Constants.URL_04,count,page),null,null,ParcelListActivity.this);
...
//                et_05.setText(null);
            ...
            case R.id.confirm:
                ...
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_04,count,s),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_04,count,s));
                }
                String prs=et_02.getText().toString().trim();
                String ps="1&fparcelarea="+prs;
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_04,count,ps),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_04,count,ps));
                }
                String prz=et_02.getText().toString().trim();
                String pz="1&vcpurpose="+prz;
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_04,count,pz),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_04,count,pz));
                }
                lineShaiXuan.setVisibility(View.GONE);
                break;
            case R.id.fab:
                startActivity(new Intent(this,Add_ParcelListActivity.class));
        }
    }
    ...
    private void getData(){
        if (!ComUtils.isNetWorkConnected(this)) {
            ...
            zDataTask.get(String.format(Constants.URL_04,count,page),null,null,this);
        }
    }
