...
import com.nxt.moderagricultrue.list.WateringList.Update_WateringListActivity;
...
public class WateringAdapter extends ZBaseAdapter<Watering> implements View.OnClickListener {
        ...
        new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Log.d("DEL",String.format(Constants.DEL_URL_08,dataList.get(itemPosition).getVcrecno()));
                        OkHttpUtils.get().url(String.format(Constants.DEL_URL_08,dataList.get(itemPosition).getVcrecno()))
                                .build()
