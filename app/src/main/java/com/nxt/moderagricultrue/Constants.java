...
public class Constants {
    ...
    //播种记录
    public static final String UPDATE_URL_06 = TEST_URL+"/seed/update.jhtml?vcrecno=%s&vcparceldesc=%s&vcparcelno=%s&vccutsno=%s&vcbreed=%s&dtseeddate=%s"+
    ...
    //灌溉记录
    public static final String UPDATE_URL_08 = TEST_URL+"/watering/waterUpdate.jhtml?vcrecno=%s&vcparcelno=%s&vcparceldesc=%s&vccutsno=%s&dtirrigatedate=%s&fwastewater=%s" +
    ...
    //茬(批)次记录
    //人员管理
    public static final String UPDATE_URL_12 = TEST_URL+"/user/update.jhtml?id_=%s&name_=%s&sex_=%s&birthday_=%s&filed1_=%s"+
            "&filed2_=%s&filed_3=%s";
    ...
    public static final String ADD_URL_05 = TEST_URL+"/plot/tidy/create.jhtml?vcoperateuser=%s&vcorgno=%s&vccutsno=%s&parcel=%s&vcparceldesc=%s"+
            "&dtreadjust=%s&vcreadjustpattern=%s&vcdisinfect=%s";
    //播种记录
    public static final String ADD_URL_06 = TEST_URL+"/seed/create.jhtml?vcoperateuser=%s&vcorgno=%s&vcparceldesc=%s&vcparcelno=%s&vccutsno=%s&vcbreed=%s&dtseeddate=%s"+
            "&vcseedpartten=%s&vcseeddensity=%s&vcfertilize=%s&dtfirstirrigate=%s";
    //施肥记录
    public static final String ADD_URL_07 = TEST_URL+"/fertilize/create.jhtml?vcoperateuser=%s&vcorgno=%s&vcparcelno=%s&vcparceldesc=%s&vccutsno=%s"+
            "&dtfertilizedate=%s&vcfertilizenum=%s&vcfertilizerrate=%s";
    //灌溉记录
    public static final String ADD_URL_08 = TEST_URL+"/watering/waterAdd.jhtml?vcorgno=%s&vcparceldesc=%s&vcparcelno=%s&vccutsno=%s&dtirrigatedate=%s&fwastewater=%s"+
            "&vcoperateuser=%s&dtoperatedate=%s";
    //病虫害防治
    public static final String ADD_URL_09 = TEST_URL+"/diseased/diseasedAdd.jhtml?vcoperateuser=%s&vcorgno=%s&vcparcelno=%s&vcparceldesc=%s&vcdrug=%s&dtpharmacydate=%s"+
            "&dtpharmacynum=%s&dtpharmacypatten=%s";
    //采收记录
    public static final String ADD_URL_10 = TEST_URL+"/recovery/save.jhtml?vcoperateuser=%s&vcorgno=%s&vcparcelno=%s&vcparceldesc=%s&vccutsno=%s&dtrecoverydate=%s"+
            "&vcrecoveryman=%s&vcmaturity=%s&frecovery=%s";
    //茬(批)次记录
    //人员管理
