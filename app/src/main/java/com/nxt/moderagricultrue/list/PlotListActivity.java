...
public class PlotListActivity extends BaseActivity implements AdapterView.OnItemClickListener{
    ...
    private PlotAdapter mBuyPageAdapter;
    private List<Plot> buyPageList=new ArrayList<>();
            ...
            public void run(){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(PlotListActivity.this, "数据已加载完毕", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
...
//                buyPageList.clear();
                try {
                    ...
                    buyPageList = new Gson().fromJson(s, new TypeToken<List<Plot>>() {
                    }.getType());
                    Log.e(TAG,buyPageList.size()+"");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                mBuyPageAdapter=new PlotAdapter(this, buyPageList);
    ...
    public void onItemClick(AdapterView<?> view, View view1, int i, long l) {
        Plot mBuypage=buyPageList.get(i);
        Log.e(TAG,i+"");
        startActivity(new Intent(this, PlotDetailActivity.class).putExtra(Constants.VCRECNO,mBuypage));
    }
}
