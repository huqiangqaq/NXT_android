...
import com.nxt.moderagricultrue.adapter.DiseasedAdapter;
...
public class DiseasedListActivity extends BaseActivity implements AdapterView.OnItemClickListener{
    ...
    protected int getLayout() {
        return R.layout.activity_diseased_list;
    }
...
//                        .getDisplayMetrics()));
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                zDataTask.get(String.format(Constants.URL_05,count,page),null,null,DiseasedListActivity.this);
...
//                et_05.setText(null);
            ...
            case R.id.confirm:
                ...
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_05,count,s),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_05,count,s));
                }
                String prs=et_02.getText().toString().trim();
                String ps="1&vcdrug="+prs;
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_05,count,ps),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_05,count,ps));
                }
                ...
                {
                    zDataTask.get(String.format(Constants.URL_05,count,buy),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_05,count,buy));
                }
            ...
            public void run(){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(DiseasedListActivity.this, "数据已加载完毕", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
    ...
    private void getData(){
        if (!ComUtils.isNetWorkConnected(this)) {
            ...
            zDataTask.get(String.format(Constants.URL_05,count,page),null,null,this);
        }
    }
...
//                buyPageList.clear();
                try {
                    ...
                    buyPageList = new Gson().fromJson(s, new TypeToken<List<Diseased>>() {
                    }.getType());
                    Log.e(TAG,buyPageList.size()+"");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                mBuyPageAdapter=new DiseasedAdapter(this, buyPageList);
                mlistview.setAdapter(mBuyPageAdapter);
            }else {
                try {
                    String s = new JSONObject(string).getString("_rows");
                    List<Diseased>  addList = new Gson().fromJson(s, new TypeToken<List<Diseased>>() {
                    }.getType());
                    if(addList.size()>0) {
                        buyPageList.clear();
    ...
    public void onItemClick(AdapterView<?> view, View view1, int i, long l) {
        Diseased mBuypage=buyPageList.get(i);
        Log.e(TAG,i+"");
        startActivity(new Intent(this, DiseasedDetailActivity.class).putExtra(Constants.VCRECNO,mBuypage));
    }
