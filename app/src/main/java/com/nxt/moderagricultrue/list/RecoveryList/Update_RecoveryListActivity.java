...
public class Update_RecoveryListActivity extends BaseActivity {
    private EditText et_zha,et_vcrecoveryman,et_vcmaturity,et_frecovery;
    private String vcparcelno,vcparceldesc,zha,dttrcoverrdate,vcrecoveryman,vcmaturity,frecovery;
    ...
    private void initData() {
        ...
        recovery = (Recovery) getIntent().getSerializableExtra(Constants.VCRECNO);
        et_vcrecoveryman.setText(recovery.getVcrecoveryman());
        et_vcmaturity.setText(recovery.getVcmaturity());
        et_frecovery.setText(recovery.getFrecovery());
        ...
        OkHttpUtils.get().url(Constants.SPINNER_URL_02 + application.getOrgID())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        sp_vcparceldesc.setAdapter(new ArrayAdapter<String>(Update_RecoveryListActivity.this, android.R.layout.simple_spinner_dropdown_item, spinner_list));
    ...
    protected int getLayout() {
        return R.layout.activity_update__recovery_list;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_update:
                ...
                if (Empty(vcparceldesc,zha,dttrcoverrdate,vcrecoveryman,vcmaturity,frecovery)){
                ...
                String ss = String.format(Constants.UPDATE_URL_10,recovery.getVcrecno(),vcparceldesc,zha,dttrcoverrdate,vcrecoveryman,vcmaturity,frecovery);
                Log.d("Update",ss);

                mDataTask.get(String.format(Constants.UPDATE_URL_10,recovery.getVcrecno(),vcparceldesc,zha,dttrcoverrdate,vcrecoveryman,vcmaturity,frecovery),null,null,this);
                break;
            case R.id.btn_time:
                DatePickerDialog dpd=new DatePickerDialog(Update_RecoveryListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        dttrcoverrdate = year+"-"+(month+1)+"-"+dayOfMonth;
                        btn_time.setText(dttrcoverrdate);
                    }
                }, year, month, day);
    ...
    public void onRequestResult(String string) {
        ...
        if (JsonUtil.PareJson(string)){
            new SweetAlertDialog(Update_RecoveryListActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText("Good job!")
                    .setContentText("修改成功")
                    .show();
        }else {
            new SweetAlertDialog(Update_RecoveryListActivity.this,SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("修改失败")
                    .show();
        }
    }
