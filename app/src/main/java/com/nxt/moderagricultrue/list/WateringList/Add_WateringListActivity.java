...
public class Add_WateringListActivity extends BaseActivity {
        ...
        OkHttpUtils.get().url(Constants.SPINNER_URL_02 + application.getOrgID())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        sp_vcparceldesc.setAdapter(new ArrayAdapter<String>(Add_WateringListActivity.this, android.R.layout.simple_spinner_dropdown_item, spinner_list));
    ...
    protected int getLayout() {
        return R.layout.activity_add__watering_list;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_add:
                ...
                String ss = String.format(Constants.ADD_URL_08,application.getOrgID(),vcparceldesc,vcparcelno,zha,dtirrigatedate,fwastewater,vcoperatrueser,dtoperatedate);
                Log.d("Update",ss);
    ...
    public void onRequestResult(String string) {
        ...
        if (JsonUtil.PareJson(string)){
            new SweetAlertDialog(Add_WateringListActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText("Good job!")
                    .setContentText("修改成功")
                    .show();
        }else {
            new SweetAlertDialog(Add_WateringListActivity.this,SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("修改失败")
                    .show();
        }
    }
