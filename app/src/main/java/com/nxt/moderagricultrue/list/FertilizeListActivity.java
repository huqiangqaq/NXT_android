...
public class FertilizeListActivity extends BaseActivity implements AdapterView.OnItemClickListener{
    ...
    protected int getLayout() {
        return R.layout.activity_fertilize_list;
    }
            ...
            public void run(){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(FertilizeListActivity.this, "数据已加载完毕", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
...
//                buyPageList.clear();
                try {
                    ...
                    buyPageList = new Gson().fromJson(s, new TypeToken<List<Fertilize>>() {
                    }.getType());
                    Log.e(TAG,buyPageList.size()+"");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                mBuyPageAdapter=new FertilizeAdapter(this, buyPageList);
