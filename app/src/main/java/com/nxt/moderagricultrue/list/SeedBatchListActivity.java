...
import com.nxt.moderagricultrue.adapter.SeedBatchAdapter;

import com.nxt.moderagricultrue.domain.SeedBatch;
import com.nxt.moderagricultrue.findbyid.FertilizeDetailActivity;
import com.nxt.moderagricultrue.findbyid.SeedbatchDetailActivity;
...
public class SeedBatchListActivity extends BaseActivity implements AdapterView.OnItemClickListener{
    ...
    private SeedBatchAdapter mBuyPageAdapter;
    private List<SeedBatch> buyPageList=new ArrayList<>();
    ...
    protected int getLayout() {
        return R.layout.activity_seedbatch_list;
    }
...
//                        .getDisplayMetrics()));
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                zDataTask.get(String.format(Constants.URL_11,count,page),null,null,SeedBatchListActivity.this);
...
//                et_05.setText(null);
            ...
            case R.id.confirm:
                ...
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_11,count,s),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_11,count,s));
                }
                String prs=et_02.getText().toString().trim();
                String ps="1&vccutsno="+prs;
                Log.e(TAG,s);
                if(prc !=null){
                    zDataTask.get(String.format(Constants.URL_11,count,ps),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_11,count,ps));
                }
                ...
                {
                    zDataTask.get(String.format(Constants.URL_11,count,buy),null,null,this);
                    Log.e(TAG,String.format(Constants.URL_11,count,buy));
                }
            ...
            public void run(){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(SeedBatchListActivity.this, "数据已加载完毕", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
    ...
    private void getData(){
        if (!ComUtils.isNetWorkConnected(this)) {
            ...
            zDataTask.get(String.format(Constants.URL_11,count,page),null,null,this);
        }
    }
...
//                buyPageList.clear();
                try {
                    ...
                    buyPageList = new Gson().fromJson(s, new TypeToken<List<SeedBatch>>() {
                    }.getType());
                    Log.e(TAG,buyPageList.size()+"");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                mBuyPageAdapter=new SeedBatchAdapter(this, buyPageList);
                mlistview.setAdapter(mBuyPageAdapter);
            }else {
                try {
                    String s = new JSONObject(string).getString("_rows");
                    List<SeedBatch>  addList = new Gson().fromJson(s, new TypeToken<List<SeedBatch>>() {
                    }.getType());
                    if(addList.size()>0) {
                        buyPageList.clear();
    ...
    public void onItemClick(AdapterView<?> view, View view1, int i, long l) {
        SeedBatch mBuypage=buyPageList.get(i);
        Log.e(TAG,i+"");
        startActivity(new Intent(this, SeedbatchDetailActivity.class).putExtra(Constants.VCRECNO,mBuypage));
    }
