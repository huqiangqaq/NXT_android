...
public class SwipeListActivity extends BaseActivity implements AdapterView.OnItemClickListener{
...
//        Log.e(TAG,encodeResult("姹熻タ鍐滀笟鍐滆嵂闆嗗洟"));
    ...
    private void initSearch(){
        ...
        et_04=(EditText)findViewById(R.id.in_start);
            ...
            public void run(){
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(SwipeListActivity.this, "数据已加载完毕", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
...
//                buyPageList.clear();
                try {
                    ...
                    buyPageList = new Gson().fromJson(s, new TypeToken<List<BuyPage>>() {
                    }.getType());
                    Log.e(TAG,buyPageList.size()+"");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                mBuyPageAdapter=new BuyPageAdapter(this, buyPageList);
