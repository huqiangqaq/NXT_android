...
public class Update_DiseasedListActivity extends BaseActivity {
    private EditText et_vcdrug,et_dtpharmacynum,et_dtpharmacypatten;
    private String vcparceldesc,vcdrug,dtpharmacydate,dtpharmacynum,dtpharmacypatten;
    ...
    private void initData() {
        ...
        diseased = (Diseased) getIntent().getSerializableExtra(Constants.VCRECNO);
        ...
        et_vcdrug.setText(diseased.getVcdrug());
        et_dtpharmacynum.setText(diseased.getDtpharmacynum());
        et_dtpharmacypatten.setText(diseased.getDtpharmacypatten());
        //获取下拉sp生产区编号
        ...
        OkHttpUtils.get().url(Constants.SPINNER_URL_02 + application.getOrgID())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        sp_vcparceldesc.setAdapter(new ArrayAdapter<String>(Update_DiseasedListActivity.this, android.R.layout.simple_spinner_dropdown_item, spinner_list));
...
//        });
    ...
    protected int getLayout() {
        return R.layout.activity_update__diseased_list;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_update:
                ...
                if (Empty(vcparceldesc,vcdrug,dtpharmacydate,dtpharmacynum,dtpharmacypatten)){
                ...
                String ss = String.format(Constants.UPDATE_URL_09,diseased.getVcrecno(),vcparceldesc,vcdrug,dtpharmacydate,dtpharmacynum,dtpharmacypatten);
                Log.d("Update",ss);

                mDataTask.get(String.format(Constants.UPDATE_URL_09,diseased.getVcrecno(),vcparceldesc,vcdrug,dtpharmacydate,dtpharmacynum,dtpharmacypatten),null,null,this);
                break;
            case R.id.btn_time:
                DatePickerDialog dpd=new DatePickerDialog(Update_DiseasedListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void onRequestResult(String string) {
        ...
        if (JsonUtil.PareJson(string)){
            new SweetAlertDialog(Update_DiseasedListActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText("Good job!")
                    .setContentText("修改成功")
                    .show();
        }else {
            new SweetAlertDialog(Update_DiseasedListActivity.this,SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("修改失败")
                    .show();
        }
    }
